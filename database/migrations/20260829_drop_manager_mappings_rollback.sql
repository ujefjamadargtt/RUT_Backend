-- Rollback for 20260829_drop_manager_mappings.sql
-- NOT auto-run by the migration runner — apply manually if ever needed.
-- Recreates the table structure only — the data is gone, this cannot
-- restore the row(s) that existed before the drop.
